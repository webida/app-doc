...
#generate doc
./node_modules/.bin/jsdoc src/webida-0.3.js src/ide.js -d doc -t ./node_modules/jsdoc/templates/webida/ -c ./node_modules/jsdoc/templates/webida/webida.conf.json
